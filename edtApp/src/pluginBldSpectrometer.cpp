...
//  BldSpectrometer_t       bldDataTemp,    *   pBldTemp    = &bldDataTemp;
    ...
    /* Start processing callbacks in NDPluginDriver */
...
extern "C" int BldSpectrometerConfigure(const char *portName, int queueSize, int blockingCallbacks,
                                 ...
                                 int priority, int stackSize, int maxThreads)
{
    PluginSpectrometer *pPlugin = new PluginSpectrometer(portName, queueSize, blockingCallbacks, NDArrayPort, NDArrayAddr,
...
static const iocshArg initArg1 = { "queueSize",iocshArgInt};
static const iocshArg initArg2 = { "blockingCallbacks",iocshArgInt};
...
static const iocshArg * const initArgs[] = {&initArg0,
                                            ...
                                            &initArg8,
                                            &initArg9};
static const iocshFuncDef initFuncDef = {"BldSpectrometerConfigure",10,initArgs};
