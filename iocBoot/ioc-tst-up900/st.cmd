...
# PV Prefixes
epicsEnvSet( "IOC_PV",	"TST:IOC:EDT:UP900" )
epicsEnvSet( "EVR_PV",	"TST:EVR:EDT:UP900" )
epicsEnvSet( "TRIG",	"0" )
epicsEnvSet( "TRIG_PV",	"$(EVR_PV):TRIG$(TRIG)" )
epicsEnvSet( "CAM_PV",	"TST:EDT:UP900" )
...
#dbLoadRecords( "db/evrPmc230.db",			"EVR=TST:EVR:EDT:UP900,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled" )
dbLoadRecords( "db/evrSLAC.db",			"EVR=TST:EVR:EDT:UP900,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled" )
