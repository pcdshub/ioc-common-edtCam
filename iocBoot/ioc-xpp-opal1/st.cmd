...
epicsEnvSet( "CAM_PV1",	"XPP:OPAL1K:1" )
...
dbLoadRecords( "db/evrPmc230.db",			"EVR=XPP:R30:EVR:27,CARD=$(EVR_CARD),IP0E=Enabled,IP1E=Enabled,IP2E=Disabled" )
#dbLoadRecords( "db/evrSLAC.db",			"EVR=XPP:R30:EVR:27,CARD=$(EVR_CARD),IP0E=Enabled,IP1E=Enabled,IP2E=Disabled" )
