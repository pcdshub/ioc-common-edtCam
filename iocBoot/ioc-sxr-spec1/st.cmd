...
epicsEnvSet( "CAM_PV1",	"SXR:SPEC:CAM:01" )
...
dbLoadRecords( "db/evrPmc230.db",			"EVR=SXR:SPEC:EVR:01,CARD=$(EVR_CARD),IP0E=Enabled,IP1E=Enabled,IP2E=Disabled" )
#dbLoadRecords( "db/evrSLAC.db",			"EVR=SXR:SPEC:EVR:01,CARD=$(EVR_CARD),IP0E=Enabled,IP1E=Enabled,IP2E=Disabled" )
