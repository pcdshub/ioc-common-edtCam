...
epicsEnvSet( "IOC",			"vioc-tst-ptm4200-1" )
...
epicsEnvSet( "SER_TRACE_IO_MASK", "5" )
...
dbLoadRecords( "db/$(EVR_DB)", "EVR=TST:EVR:EDT:PTM1,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled,IP1E=Enabled" )
