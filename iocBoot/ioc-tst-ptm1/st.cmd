...
# PV Prefixes
epicsEnvSet( "IOC_PV",	"TST:IOC:EDT:PTM1" )
epicsEnvSet( "EVR_PV",	"TST:EVR:EDT:PTM1" )
epicsEnvSet( "TRIG",	"0" )
epicsEnvSet( "TRIG_PV",	"$(EVR_PV):TRIG$(TRIG)" )
epicsEnvSet( "CAM_PV",	"TST:EDT:PTM1" )
...
#dbLoadRecords( "db/evrPmc230.db",			"EVR=TST:EVR:EDT:PTM1,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled" )
dbLoadRecords( "db/evrSLAC.db",			"EVR=TST:EVR:EDT:PTM1,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled" )
