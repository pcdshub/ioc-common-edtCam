...
#dbLoadRecords( "db/evrPmc230.db",		"EVR=$(EVR_PV),CARD=$(EVR_CARD),IP4E=Enabled" )
dbLoadRecords( "db/evrSLAC.db",			"EVR=$(EVR_PV),CARD=$(EVR_CARD),IP4E=Enabled" )
