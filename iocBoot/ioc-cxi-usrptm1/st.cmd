...
epicsEnvSet( "LOCATION",	"CXI User Chamber" )
...
# PV Prefixes
epicsEnvSet( "IOC_PV",	"CXI:USR:IOC:PTM1" )
epicsEnvSet( "EVR_PV",	"CXI:USR:EVR:PTM1" )
epicsEnvSet( "TRIG",	"0" )
epicsEnvSet( "TRIG_PV",	"$(EVR_PV):TRIG$(TRIG)" )
epicsEnvSet( "CAM_PV",	"CXI:USR:CVV:PTM1" )
...
dbLoadRecords( "db/evrPmc230.db",			"EVR=CXI:USR:EVR:PTM1,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled" )
#dbLoadRecords( "db/evrSLAC.db",			"EVR=CXI:USR:EVR:PTM1,CARD=$(EVR_CARD),IP$(TRIG)E=Enabled" )
